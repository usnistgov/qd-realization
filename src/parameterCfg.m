...
if ~isfield(para, 'switchQDApproach')
    error(strcat('Approach to generate diffuse components is not ',....
    ' defined. Consider switchQDApproach = 1 for NIST measurement based ',....
    ' scenarios or  switchQDApproach = 2 for 11ay channel document ',....
    ' based scenarios in paraCfgCurrent.txt file.'));
...
elseif str2num(para.switchQDApproach) == 1....
    ...
    elseif strcmp(para.environmentFileName,'Box.xml') ||...
        strcmp(para.inputScenarioName(10:end),'Sphere.xml') ||...
    ...
    error(strcat('Approach to generate diffuse components can be ',....
    'either 1 or 2. Define switchQDApproach = 1 for NIST measurement',....
    ' based scenarios or  switchQDApproach = 2 for 11ay channel ',....
    ' document based scenarios in paraCfgCurrent.txt file.'));
end
