function [output, multipath, currentMaxPathGain] = mymultipath(rxPos, txPos,...
    rxVel, txVel, triangIdxList, cadData, materialLibrary, switchQd,...
    switchMaterial, freq, minAbsolutePathGainThreshold,...
...
for i = 1:triangListLen
    ...
    [pathExists, dod, doa, rowMultipath, rayLen, dopplerFactor, pathGain,...
        ...
        currentTriangIdxs, cadData, materialLibrary, switchQd, switchMaterial, freq,...
