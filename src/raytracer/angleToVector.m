...
%ANGLETOVECTOR returns the angle vector given in input angles and delay of
%the ray.
%
%angleVector = ANGLETOVECTOR(az, el, delay)
%ANGLETOVECTOR converts the azimuth az and the elevation el in the the
