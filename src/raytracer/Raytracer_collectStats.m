function [outputPath] = Raytracer_collectStats(paraCfgInput,nodeCfgInput)
% Inputs:
...
endout=regexp(inputScenarioName,filesep,'split');

CADpath = fullfile(endout{1},endout{2});
[CADop, switchMaterial] = getCadOutput(environmentFileName,...
    CADpath, MaterialLibrary, referencePoint, selectPlanesByDist, indoorSwitch);
